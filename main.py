...
class MainMenu(QMainWindow):
    def __init__(self):
        ...
        # Add create toolbar and toolbar elements
        toolbar = QToolBar()
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        The app was the student registration app.
        I can done the app during the course and i can develop my skill.Fell free to modify and run this app. The App was developed by Tharun. 
        """
